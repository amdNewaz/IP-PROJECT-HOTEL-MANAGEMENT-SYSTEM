...
<html>
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs">
      <li class="nav-item">
          <a class="nav-link active" aria-current="true" style="color:maroon" href="RoomList.jsp"><b>Book Room</b></a>
      </li>
      <li class="nav-item">
          <a class="nav-link" href="viewRoomList.jsp" style="color:black" ><b>View Bookings</b></a>
      </li>
    </ul>
  </div>
  <div class="card-body" style="padding-left: 170px;padding-top: 30px" >
    ...
    <textarea class="form-control" style="border-color: maroon;width:500px" 
      ...
      <label style="padding-right: 1140px"><b>Phone Number</b></label>
    <input class="form-control" style="border-color: maroon;width:500px" 
