...
<html>
    <head>
        ...
        <title>Team06:ROMS-Edit booking</title>
    ...
    <body>
        <h3 style="padding-top: 30px;padding-left: 20px">Edit Booking Info</h3>
        <%
        ...
        <form action="editEmp" method="post">
            <%
                ...
                String data = "select * from bookinglist where id='"+num+"'";
    ...
    <div class="col-sm-8" style="padding-left: 650px">
        <table>
            <br><tr><td> <a href ='viewRoomList.jsp' class="btn btn-dark" style="width:80px;">Back</a></td>
